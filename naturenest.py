...
selected2 = option_menu("", ["Home", "Events", "Purdue", "Discuss", "Profile"],
    icons=['house', 'calendar-event', "building", 'chat', 'person-circle'],
...
if selected2 == "Events":
    ...
    c7.image(Image.open("/Users/monish/Desktop/Immunization Proof/NIU.png"), width = 150)
    c8.subheader("Event:")
    ...
    if check:
       c12.write("You're attending the Chicagoland Safety Health & Environmental Conference on 9/18/2023!")

    st.write(" ")

    st.header(" ")
    c13,c14,c15,c16 = container.columns(4)
    c13.image(Image.open("/Users/monish/Desktop/Immunization Proof/NCNA.jpeg"), width = 150)
    c14.subheader("Event:")
    ...
    c4.write("12/5/2023")
    container.write("Description:")
    container.caption("World Soil Day 2022 (#WorldSoilDay) and its campaign" + "Soils: Where food begins" + "aims to raise awareness of the importance of maintaining healthy ecosystems and human well-being by addressing the growing challenges in soil management, increasing soil awareness and encouraging societies to improve soil health.")
    c5, c6 = container.columns(2)
...
if selected2 == "Home":
    ...
    st.write("- Look below for a map of the distribution of CO2 emissions around the globe")
    st.write("- Another tab below shows the environmental nonprofits in the area")
    st.write("- Check out our Events page to host or participate in an environmental event")
    st.write("- Our Purdue page shows environmental information and ways to get involved")
    ...
    with co2tab:
        ...
        df = pd.read_csv('owid-co2-data.csv', usecols=['country', 'co2', "year"])
        df = df[df['year'] == 2021]
    ...
    with nontab:
        ...
        folium.Marker(
            ...
            icon=folium.Icon(color="brown", icon='fa-person-hiking', prefix='fa'),
            tooltip=tooltip
        ).add_to(n)
...
if selected2 == "Purdue":
    ...
    col1.image(Image.open("/Users/monish/Desktop/Immunization Proof/p agriculture.png"), width = 150)
    ...
    container = st.container()
    col1, col2, col3, col4= container.columns(4)
    col1.image(Image.open("/Users/monish/Desktop/Immunization Proof/go greener.jpeg"), width = 150)
    col2.subheader("Event:")
    ...
    container = st.container()
    col1, col2, col3, col4= container.columns(4)
    col1.image(Image.open("/Users/monish/Desktop/Immunization Proof/green trees.jpeg"), width = 150)
    col2.subheader("Event:")
    ...
    if check:
        col5.write("You're attending the West Lafayette Tree Planting Workshop on 10/29/23!")
...
if selected2 == "Profile":
    ...
    selected_button = st.sidebar.radio("Choose an option:", ("Login", "Sign-up"))
